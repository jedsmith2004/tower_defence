...
class Nailer:
    ...
    def render(self, display, enemies, game):
        for enemy in enemies:
            steps =  math.sqrt((enemy.pos[0] - self.pos[0])**2 + (enemy.pos[1] - self.pos[1])**2) / self.projectile_speed
            pos = game.path_evolution(enemy.perc + enemy.speed * (steps-3))
